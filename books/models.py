...
class Book(models.Model):
    ...
    author = models.ForeignKey('Author', on_delete=models.SET_NULL, null=True, default=True)
    ...
    summary = models.TextField(max_length=10000, help_text="Enter a brief description of the book", default="DEFAULT VALUE")
